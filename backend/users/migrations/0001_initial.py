    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external_id', models.PositiveIntegerField(unique=True, verbose_name='ID пользователя в Телеграм')),
                ...
                ('status', models.CharField(choices=[('is_active', 'Активный'), ('is_readonly', 'Только чтение'), ('is_blocked', 'Заблокирован')], default='is_active', max_length=255, verbose_name='Статус')),
            ],
            options={
